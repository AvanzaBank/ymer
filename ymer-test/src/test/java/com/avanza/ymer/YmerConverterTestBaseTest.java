...
public class YmerConverterTestBaseTest {
	...
	@Test
	public void spaceObjectWithAutoGeneratedIdAndWithoutRoutingAnnotationFails() throws Exception {
		final FakeTestSuite test1 = new FakeTestSuite(
				new ConverterTest<>(new TestSpaceObjectWithAutoGeneratedIdAndWithoutRoutingKeyAnnotation("id123")));
		assertFails(new TestRun() {
			@Override
			void run() throws Exception {
				test1.failForAutoGeneratedIdWithoutExplicitSpaceRouting();
			}
		});
	}

	@Test
	public void spaceObjectWithoutAutoGeneratedIdOrRoutingAnnotationSucceeds()
			throws Exception {
		final FakeTestSuite test1 = new FakeTestSuite(
				new ConverterTest<>(new WithoutAutoGeneratedIdOrRoutingAnnotation("id123")));
		assertPasses(new TestRun() {
			@Override
			void run() throws Exception {
				test1.failForAutoGeneratedIdWithoutExplicitSpaceRouting();
	...
	@Test
	public void spaceObjectWithAutoGeneratedIdAndRoutingKeyAnnotationSucceeds() throws Exception {
		final FakeTestSuite test1 = new FakeTestSuite(
				new ConverterTest<>(new TestSpaceObjectWithAutoGeneratedIdAndRoutingKeyAnnotation("id123")));
		assertPasses(new TestRun() {
			@Override
			void run() throws Exception {
				test1.failForAutoGeneratedIdWithoutExplicitSpaceRouting();
	...
	@Test
	public void findsSpaceRoutingAnnotationFromImmediateSuperclass()
			throws Exception {
		final FakeTestSuite test1 = new FakeTestSuite(
				new ConverterTest<>(new TestSpaceObjectInheritingAutoGeneratedIdAndRoutingKeyAnnotation()));
		assertPasses(new TestRun() {
			@Override
			void run() throws Exception {
				test1.failForAutoGeneratedIdWithoutExplicitSpaceRouting();
	...
	@Test
	public void findsSpaceRoutingAnnotationFromAnySuperclass()
			throws Exception {
		final FakeTestSuite test1 = new FakeTestSuite(
				new ConverterTest<>(new TestSpaceObjectInheritingAutoGeneratedIdAndRoutingKeyAnnotation() {
					// inner anonymous grandchild
				}));
		assertPasses(new TestRun() {
			@Override
			void run() throws Exception {
	...
	@Test
	public void spaceObjectWithPrivateRoutingKeyAnnotationSucceeds() throws Exception {
		final FakeTestSuite test1 = new FakeTestSuite(
				new ConverterTest<>(new TestSpaceObjectWithRoutingKeyAnnotationOnPrivateProperty("id123")));
		assertPasses(new TestRun() {
			@Override
			void run() throws Exception {
				test1.failForAutoGeneratedIdWithoutExplicitSpaceRouting();
