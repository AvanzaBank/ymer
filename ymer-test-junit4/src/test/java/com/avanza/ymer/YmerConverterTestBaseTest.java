...
public class YmerConverterTestBaseTest {
	...
	public void spaceObjectWithEmptyIdAndAutogeneratedSpaceIdSucceeds() throws Exception {
		final FakeTestSuiteWithAutogeneratedId test1 = new FakeTestSuiteWithAutogeneratedId(
	...
	static class FakeTestSuiteWithAutogeneratedId extends YmerConverterTestBase {

		public FakeTestSuiteWithAutogeneratedId(ConverterTest<?> testCase) {
			super(testCase);
		}
		...
		protected Collection<MirroredObjectDefinition<?>> getMirroredObjectDefinitions() {
			DocumentPatch[] patches = {};
			return List.of(MirroredObjectDefinition.create(TestSpaceObjectAutogeneratedId.class).documentPatches(patches));
		}
